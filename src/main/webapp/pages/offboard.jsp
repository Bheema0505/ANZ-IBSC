    ...
    <div class="right-content">
      ...
      <span class="user-name"><%=session.getAttribute("user.name") %></span>
  			...
  			<div class="remove-user-warn-txt">
                ...
                <span> Off-board</span>, Below user won't be able to perform any further actions in IBSC application </span></p>
            </div>
	
	 <div class="rem-usr-cont" >
	 	<form class="rounded bg-white shadow p-5" action="../do" method=post>
	 	 <input type=hidden name="actionStr" value="offboarduser">
	 	  <input type=hidden name="delEmpId" value="<%=empId %>">
	            <span class="add-user-txt">Are you sure, you want to Off-board this user?</span>
	            ...
	            <button type="submit" class="btn btn-warning rem-usr-submit-btn w-50 y-4">Off-board</button>
			</form>
	    </div>
